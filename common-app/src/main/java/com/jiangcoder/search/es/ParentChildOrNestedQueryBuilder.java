...
public class ParentChildOrNestedQueryBuilder {
	...
	protected  Logger logger = LoggerFactory
			.getLogger(ParentChildOrNestedQueryBuilder.class);
...
//			 searchBuilder.toString() });
	...
	public ParentChildOrNestedQueryBuilder preference(String preference) {
	...
	public ParentChildOrNestedQueryBuilder setIndices(String... indices) {
		searchBuilder.setIndices(indices);
		return this;
	}

	public ParentChildOrNestedQueryBuilder setTypes(String... types) {
		searchBuilder.setTypes(types);
		return this;
	}

	public ParentChildOrNestedQueryBuilder addSkuTermFilter(String field,
			Object value) {
	...
	public ParentChildOrNestedQueryBuilder addFilter(FilterType type,
	...
	public ParentChildOrNestedQueryBuilder setScriptParm(String key,
			Object value) {
		setScript(null);
	...
	public ParentChildOrNestedQueryBuilder setScript(String script) {
	...
	public ParentChildOrNestedQueryBuilder fake(boolean fake) {
		this.fake = fake;
		return this;
	}

	public ParentChildOrNestedQueryBuilder catIds(String catIds) {
		this.catIds = catIds;
		return this;
	}

	public ParentChildOrNestedQueryBuilder regionId(String regionId) {
	 ...
	 * @param @return 设定文件
	 * @return ParentChildOrNestedQueryBuilder 返回类型
	 * @throws
	 */
	public ParentChildOrNestedQueryBuilder makeUpQuery(String luceneQueryString) {
		...
		if (!StringUtils.isEmpty(luceneQueryString)) {
			...
			if (functionBuilder == null
				...
				CustomFunctionScoreQueryBuilder functionQuery = getFunctionQuery(
	...
	private void makeUpNestedQuery(
			CustomFunctionScoreQueryBuilder functionQuery,
	 ...
	 * @throws
	 */
	private void buildCustomParam(CustomFunctionScoreQueryBuilder functionQuery) {
	 ...
	 * @throws
	 */
	private CustomFunctionScoreQueryBuilder getFunctionQuery(
		...
		if (luceneQueryString.contains(SQL_ALL)) {
			functionQuery = new CustomFunctionScoreQueryBuilder(
	...
	public ParentChildOrNestedQueryBuilder preference4Test(String ipPort) {
	...
	//cityId string
	public ParentChildOrNestedQueryBuilder extraParam(String extraParam){
	
		this.searchBuilder.setExtraParam(extraParam);
		return this;
	}

	public ParentChildOrNestedQueryBuilder cityId(String cityId) {
		this.cityId = cityId;
		return this;
	}

	public ParentChildOrNestedQueryBuilder addSkuFilter(FilterBuilder filter) {

		return addFilter(FilterType.FILTER, null, null, null, filter, null,
				null, skuFilters);
	}
	
	public ParentChildOrNestedQueryBuilder addSkuRangeFilter(String field, String range) throws Exception{
	...
	public ParentChildOrNestedQueryBuilder addSkuRangeFilter(String field, Object from, Object to) {

		return addFilter(FilterType.RANGE, field, from, to, null, null, null,skuFilters);
	}
	
	public ParentChildOrNestedQueryBuilder addSkuNotFilter(String field, Object value) {

		return addFilter(FilterType.NOT, field, value, null, null, null, null,skuFilters);
	}
	
	public ParentChildOrNestedQueryBuilder addFacet(String... fields) {
	...
	public ParentChildOrNestedQueryBuilder addFacetForShoppingCartSearch(String... fields) {
	 ...
	 * @throws
	 */
	public ParentChildOrNestedQueryBuilder addFacet(String field, boolean filtered, Integer size) {
	...
	public ParentChildOrNestedQueryBuilder addFacetForShoppingCartSearch(String field, boolean filtered, Integer size) {
	...
	public ParentChildOrNestedQueryBuilder from(int from) {
		this.searchBuilder.setFrom(from);
		return this;
	}
	
	public ParentChildOrNestedQueryBuilder size(int size) {
		this.searchBuilder.setSize(size);
		return this;
	}
	
	public ParentChildOrNestedQueryBuilder sort(String field, SortOrder order) {
		this.searchBuilder.addSort(SortBuilders.fieldSort(field).order(order).missing("_last"));
		return this;
	}
	
	public ParentChildOrNestedQueryBuilder addSkuOrFilter(String field, List<?> orValues) {

		return addFilter(FilterType.OR, field, null, null, null, orValues, null,skuFilters);
	}
	
	public ParentChildOrNestedQueryBuilder setExplain(boolean enabled) {
...
//						}
	...
	public ParentChildOrNestedQueryBuilder removeSkuFilter(FilterBuilder filter) {
		skuFilters.remove(filter);
		return this;
	}
	public ParentChildOrNestedQueryBuilder addTermFilter(String field, Object value) {
